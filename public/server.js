    ...
    req.on("end", () => { //Listen for the request ReadStream ‘end’ event
        ...
        if (url === "/newsletter_signup" && method === "POST") { // check the request url and method, and if they are “POST” and “/newsletter_signup”,
            ...
            res.write(
                ...
                JSON.stringify({ msg: "Signed up" }) // write response to the client
        ...
        } else if (url === "/newsletter_signup" && method === "GET") { //Add an else/if to your conditional that checks for request method and url.
